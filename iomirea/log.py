        ...
        if record.levelno == logging.ERROR:
            ...
            if self.app['args'].debug:
                ...
                self.app.loop.run_in_executor(
                    None, send_report, self._format_report_text(record),
                    self.app
                )
...
def setup_logging(app):
    ...
    access_stream_handler.setFormatter(logging.Formatter(
    ...
    stream_handler.setFormatter(logging.Formatter(
        log_config['basic-log-format'] + '{msg}', style='{',
        datefmt=log_config['basic-time-format']
    ))

    common_file_handler.setFormatter(logging.Formatter(
        log_config['basic-log-format'] + '{msg}', style='{',
        datefmt=log_config['basic-time-format']
    ))

    server_file_handler.setFormatter(logging.Formatter(
        log_config['basic-log-format'] + '{msg}', style='{',
        datefmt=log_config['basic-time-format']
    ))
